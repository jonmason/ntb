...
extern void nx_soc_gpio_set_io_pull_enb(unsigned int io, int on);
extern int nx_soc_gpio_get_io_pull_enb(unsigned int io);
extern void nx_soc_gpio_set_io_pull_sel(unsigned int io, int up);
extern int nx_soc_gpio_get_io_pull_sel(unsigned int io);
