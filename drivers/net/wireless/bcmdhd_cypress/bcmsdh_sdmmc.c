 ...
 *
 * $Id: bcmsdh_sdmmc.c 674219 2017-10-12 20:23:32Z $
 */
#include <typedefs.h>
...
uint sd_msglevel = SDH_ERROR_VAL; //0x01;  htdo use defiend string.  and, only print err message.  because other message levels are disabled
