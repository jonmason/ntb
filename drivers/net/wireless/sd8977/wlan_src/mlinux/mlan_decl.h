...
#define MLAN_RELEASE_VERSION		 "C144"
...
#define MLAN_BUF_FLAG_ARP               MBIT(12)
#define RATEID_OFDM6Mbps                0x5
#define RATEID_DBPSK1Mbps               0x0
#define RATE_CONTROL_ENABLE             0x10
...
typedef enum _mlan_event_id {
	...
	MLAN_EVENT_ID_FW_SUCC_TX_FAIL = 0x00000035,
