...
static const struct rfkill_ops bcm434545_bt_rfkill_ops = {
	.set_block = bcm434545_bt_rfkill_set_power,
};
...
static struct platform_driver bcm434545_bluetooth_platform_driver = {
